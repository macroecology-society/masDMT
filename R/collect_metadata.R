...
#' following the path set in options. If no file exists, a new one will be 
#' created. If a file exists, the function will read it, list all files 
#' currently in the database, and update the list if the last modification 
#' date differs, or if new files were added.}
