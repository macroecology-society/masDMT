#' Pull the areal data from an arealDB database
#'
...
#'   bind_rows arrange summarise_at all_of any_of
#' @export

pull_arealData <- function(path = NULL, nation = NULL, pID = NULL, geoID = NULL,
